 ...
 */
;jQuery(document).ready(function(){var a=jQuery;a(".gallery").each(function(){var b=a(this).attr("id");a(this).find("a").each(function(){if(a(this).attr("href").indexOf("attachment_id")===-1){a(this).attr("data-fancybox",b)}})})});
/*!
 * fancyBox v3.0.47
 *
